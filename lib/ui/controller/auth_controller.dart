...
class AuthController {
  ...
  static const _verificationEmailKey = 'verification-email';
  static const _verificationOTPKey = 'verification-otp';
  ...
  static Future<void> saveVerificationEmail(String email) async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    await sharedPreferences.setString(_verificationEmailKey, email);
    verificationEmail = email;
  }

  static Future<String?> getVerificationEmail() async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    return sharedPreferences.getString(_verificationEmailKey);
  }

  static Future<void> saveVerificationOTP(String otp) async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    await sharedPreferences.setString(_verificationOTPKey, otp);
    verificationOTP = otp;
  }

  static Future<String?> getVerificationOTP() async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    return sharedPreferences.getString(_verificationOTPKey);
  }
